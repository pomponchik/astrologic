...
3. Что-то делаем с полученным AST. На выходе у нас должно получиться другое AST. По сути это единственная часть в нашем уравнении, которая будет разной для разных модификаций, так что подробнее об этом будет далее.
